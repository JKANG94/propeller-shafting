function [propeller,mid_shaft_i,fu,fv]=first_propeller1_matrix_space(ku,kv,kw,kru,krv,b,h,L,q0w,hq0w,w,ii,n,a,attack_ang)


E=4.2e11*(1+0.01i);  coe=5/6; G=E/2/(1+0.32);       %弹性模量、铁木辛柯剪切系数、切变弹性模量
Area=b*h;  density=9900;

Forceu=1*cos(attack_ang);  %距离叶梢距离，载荷
% Forceu=1; 
%横向1---振动(u方向）
