function result_matrix=condition_matrix_space(w)
% 返回桨-轴系统给定频率值处平衡条件矩阵
...
% 
% kr1u=4e7; kr1v=1e7; kr1w=2e7;  %扭转刚度
...
B0v_3=[coe*G*Area3*[belta*sinh(lambda*L03),belta*cosh(lambda*L03),yita*sin(hlambda*L03),-yita*cos(hlambda*L03)]-...
    ...
    q*lambda*cosh(lambda*L03),q*lambda*sinh(lambda*L03),hq*hlambda*cos(hlambda*L03),hq*hlambda*sin(hlambda*L03)];
...
[propeller_1,mid_shaft_1]=propeller1_matrix_space(pro_E,pro_density,ue,k1u,k1v,k1w,kr1u,kr1v,b,h,L,q0w,hq0w,w,ii,n);


%第二根桨叶

ii=2;  L=L2;   %调用函数得到第i根桨叶条件矩阵
[propeller_2,mid_shaft_2]=propeller2_matrix_space(pro_E,pro_density,ue,k2u,k2v,k2w,kr2u,kr2v,b,h,L,q0w,hq0w,w,ii,n);


%第三根桨叶
ii=3;   L=L3;   %调用函数得到第i根桨叶条件矩阵
[propeller_3,mid_shaft_3]=propeller3_matrix_space(pro_E,pro_density,ue,k3u,k3v,k3w,kr3u,kr3w,b,h,L,q0v,hq0v,w,ii,n);


%第四根桨叶

ii=4;   L=L4;   %调用函数得到第i根桨叶条件矩阵
[propeller_4,mid_shaft_4]=propeller4_matrix_space(pro_E,pro_density,ue,k4u,k4v,k4w,kr4u,kr4w,b,h,L,q0v,hq0v,w,ii,n);

shaft=[mid_shaft_0,mid_shaft_1,mid_shaft_2,mid_shaft_3,mid_shaft_4]; % 轴系边界条件矩阵
