function [propeller,mid_shaft_i]=propeller4_matrix_space(E,density,ue,ku,kv,kw,kru,krw,b,h,L,q0v,hq0v,w,ii,n)
...
Boundary_w=[belta*sinh(lambda*L),belta*cosh(lambda*L),yita*sin(hlambda*L),-yita*cos(hlambda*L);...
    q*lambda*cosh(lambda*L),q*lambda*sinh(lambda*L),hq*hlambda*cos(hlambda*L),hq*hlambda*sin(hlambda*L)];
