function [hengmatrix,zongmatrix,niumatrix,heng2,zong2,niu2]=transfer_matrix(hspring1,hspring2,L1,L2,d1,d2,d3,w)


E=2.1e11;  coe=0.9; G=E/2/(1+0.3); density=7500;  % 轴--物理参数
...
ei=MI1/MI2;  kga=Area1/Area2;   %轴系圆柱截面
